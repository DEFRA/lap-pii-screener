...
# safer than a blanket autoescape=False.  Autoescape is deliberately disabled
# for .md.j2 (plain text); HTML escaping is not applicable here (rule S5247).
_MD_ENV = Environment(
    loader=FileSystemLoader(str(TEMPLATE_DIR)),
    autoescape=select_autoescape(enabled_extensions=("html", "xml")),  # NOSONAR
)
